...
- (void)testLaunchDeepLink
{
    ...
    sessionResponseData.jsonResponse = [self getDeeplinkDictionary];
    ...
    attributionResponseData.jsonResponse = [self getDeeplinkDictionary];
...
- (NSDictionary *)getDeeplinkDictionary {
